...
export default function ScoringScreen({
  ...
  return (
    <div className="screen figma-scoring-screen">
      ...
      {/* Main Scoring Body: Side-by-side in landscape/iPad, stacked in portrait */}
      <div className="scoring-main-body">
        <div className="scoring-turn-column">
          {isRoundScored ? (
        ...
        <div className="scoring-standings-column">
